      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="flex items-center justify-center ">
            ...
            <input type="file" id="file" className="hidden" value={image} onChange={(e)=>setImage(e.target.value)}/>
          </div>
          {image}
        </div>
        <DialogFooter>
          <Button type="submit" className="bg-blue-600" onClick={handleSendReview}>
            Send
          </Button>
        </DialogFooter>
      </DialogContent>
